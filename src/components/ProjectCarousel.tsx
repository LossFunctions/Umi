...
const ProjectCarousel: React.FC<ProjectCarouselProps> = ({
  ...
  return (
    <div className="relative">
      {/* Hard shadow - minimal offset like other cards */}
      <div className="w-full h-full absolute inset-0 bg-gray-900 rounded-xl translate-y-1 translate-x-1"></div>
      
      {/* Main carousel container - tight around media only */}
      <div className="relative z-20 bg-white rounded-xl border-[3px] border-gray-900 overflow-hidden">
        {/* Media display - no extra padding or spacing */}
